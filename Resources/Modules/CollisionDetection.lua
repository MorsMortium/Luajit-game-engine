return function(args)
  ...
  local SameLayer, pairs, VectorSubtraction, DotProduct, VectorScale,
  VectorAddition, CrossProduct, Normalise, VectorZero, VectorEqual =
  General.Library.SameLayer, pairs, General.Library.VectorSubtraction,
  General.Library.DotProduct, General.Library.VectorScale,
  General.Library.VectorAddition, General.Library.CrossProduct,
  General.Library.Normalise, General.Library.VectorZero, General.Library.VectorEqual

  local GiveBack = {}

  function GiveBack.Reload(args)
    General = args[1]
    SameLayer, pairs, VectorSubtraction, DotProduct, VectorScale,
    VectorAddition, CrossProduct, Normalise, VectorZero, VectorEqual =
    General.Library.SameLayer, pairs, General.Library.VectorSubtraction,
    General.Library.DotProduct, General.Library.VectorScale,
    General.Library.VectorAddition, General.Library.CrossProduct,
  ...
  function GiveBack.DetectCollisions(AllDevices)
    ...
    for ak=1,#BroadCollisions do
      ...
      GiveBack.GJK(av[1], av[2], mtv) then
