-- matrix.lua
--
-- Real and complex matrix, and complex scalar data types, featuring
-- arithmetic operators that allow mixing of matrix and scalar types.
--
...
package.loaded["lgsl.complex"] = complex
